...
HD_PWD='D:/BaiduNetdiskDownload/P10_SD_VGA_m/IP_REPO/VIP/TestPattern/TestPattern/impl/verilog/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_pattern1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_pattern1.tcl
