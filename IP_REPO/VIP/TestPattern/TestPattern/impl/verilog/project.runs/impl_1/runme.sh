...
HD_PWD='D:/BaiduNetdiskDownload/P10_SD_VGA_m/IP_REPO/VIP/TestPattern/TestPattern/impl/verilog/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_pattern1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_pattern1.tcl -notrace
