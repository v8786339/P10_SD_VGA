...
output [24 - 1:0] src_axi0_TDATA ;
output [3 - 1:0] src_axi0_TKEEP ;
output [3 - 1:0] src_axi0_TSTRB ;
output [1 - 1:0] src_axi0_TUSER ;
output [1 - 1:0] src_axi0_TLAST ;
output [1 - 1:0] src_axi0_TID ;
output [1 - 1:0] src_axi0_TDEST ;
...
wire sig_test_pattern1_ap_start;
wire sig_test_pattern1_ap_ready;
wire sig_test_pattern1_ap_done;
wire sig_test_pattern1_ap_idle;

wire sig_test_pattern1_ap_rst_n;



test_pattern1 test_pattern1_U(
    .ap_start(sig_test_pattern1_ap_start),
    .ap_ready(sig_test_pattern1_ap_ready),
    .ap_done(sig_test_pattern1_ap_done),
    .ap_idle(sig_test_pattern1_ap_idle),
    .ap_rst_n(sig_test_pattern1_ap_rst_n),
    .ap_clk(aclk),
...
test_pattern1_CONTROL_BUS_if #(
    .C_ADDR_WIDTH(C_S_AXI_CONTROL_BUS_ADDR_WIDTH),
    .C_DATA_WIDTH(C_S_AXI_CONTROL_BUS_DATA_WIDTH))
test_pattern1_CONTROL_BUS_if_U(
    .ACLK(aclk),
    .ARESETN(aresetn),
    .I_ap_start(sig_test_pattern1_ap_start),
    .O_ap_ready(sig_test_pattern1_ap_ready),
    .O_ap_done(sig_test_pattern1_ap_done),
    .O_ap_idle(sig_test_pattern1_ap_idle),
...
test_pattern1_ap_rst_n_if #(
    .RESET_ACTIVE_LOW(RESET_ACTIVE_LOW))
ap_rst_n_if_U(
    .dout(sig_test_pattern1_ap_rst_n),
    .din(aresetn));
