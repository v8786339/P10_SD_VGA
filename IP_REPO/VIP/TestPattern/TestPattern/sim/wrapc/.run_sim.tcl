...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "test_pattern1.autotvin.dat"
	set constFileTvOut       "test_pattern1.autotvout.dat"
	set constFileHdlTvIn     "test_pattern1.autohdltvin.dat"
	set constFileHdlTvOut    "test_pattern1.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
