...
always @ (*) begin
    if ((((ap_reg_pp0_iter1_exitcond_reg_234 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((exitcond_reg_234 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
        src_axi0_TDATA_blk_n = AXI_video_strm_V_data_V_1_state[1'd1];
    end else begin
...
assign AXI_video_strm_V_data_V_1_ack_out = src_axi0_TREADY;
...
assign AXI_video_strm_V_dest_V_1_ack_out = src_axi0_TREADY;
...
assign AXI_video_strm_V_id_V_1_ack_out = src_axi0_TREADY;
...
assign AXI_video_strm_V_keep_V_1_ack_out = src_axi0_TREADY;
...
assign AXI_video_strm_V_last_V_1_ack_out = src_axi0_TREADY;
...
assign AXI_video_strm_V_strb_V_1_ack_out = src_axi0_TREADY;
...
assign AXI_video_strm_V_user_V_1_ack_out = src_axi0_TREADY;
...
assign exitcond1_fu_168_p2 = ((t_V_reg_141 == 10'd960) ? 1'b1 : 1'b0);
...
assign src_axi0_TDATA = AXI_video_strm_V_data_V_1_data_out;

assign src_axi0_TDEST = AXI_video_strm_V_dest_V_1_data_out;

assign src_axi0_TID = AXI_video_strm_V_id_V_1_data_out;

assign src_axi0_TKEEP = AXI_video_strm_V_keep_V_1_data_out;

assign src_axi0_TLAST = AXI_video_strm_V_last_V_1_data_out;

assign src_axi0_TSTRB = AXI_video_strm_V_strb_V_1_data_out;

assign src_axi0_TUSER = AXI_video_strm_V_user_V_1_data_out;

assign src_axi0_TVALID = AXI_video_strm_V_dest_V_1_state[1'd0];
