...
`define TV_OUT_dst_axi_TDATA "./impl_rtl.vip1_m.autotvout_dst_axi_V_data_V.dat"
`define EGRESS_STATUS_dst_axi_TDATA "./stream_egress_status_dst_axi_V_data_V.dat"
`define TV_OUT_dst_axi_TKEEP "./impl_rtl.vip1_m.autotvout_dst_axi_V_keep_V.dat"
`define EGRESS_STATUS_dst_axi_TKEEP "./stream_egress_status_dst_axi_V_keep_V.dat"
`define TV_OUT_dst_axi_TSTRB "./impl_rtl.vip1_m.autotvout_dst_axi_V_strb_V.dat"
`define EGRESS_STATUS_dst_axi_TSTRB "./stream_egress_status_dst_axi_V_strb_V.dat"
`define TV_OUT_dst_axi_TUSER "./impl_rtl.vip1_m.autotvout_dst_axi_V_user_V.dat"
`define EGRESS_STATUS_dst_axi_TUSER "./stream_egress_status_dst_axi_V_user_V.dat"
`define TV_OUT_dst_axi_TLAST "./impl_rtl.vip1_m.autotvout_dst_axi_V_last_V.dat"
`define EGRESS_STATUS_dst_axi_TLAST "./stream_egress_status_dst_axi_V_last_V.dat"
`define TV_OUT_dst_axi_TID "./impl_rtl.vip1_m.autotvout_dst_axi_V_id_V.dat"
`define EGRESS_STATUS_dst_axi_TID "./stream_egress_status_dst_axi_V_id_V.dat"
`define TV_OUT_dst_axi_TDEST "./impl_rtl.vip1_m.autotvout_dst_axi_V_dest_V.dat"
