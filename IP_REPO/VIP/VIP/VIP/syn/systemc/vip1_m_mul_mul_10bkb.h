...
#ifndef __vip1_m_mul_mul_10bkb__HH__
#define __vip1_m_mul_mul_10bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(vip1_m_mul_mul_10bkb) {
    ...
    SC_CTOR(vip1_m_mul_mul_10bkb):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
