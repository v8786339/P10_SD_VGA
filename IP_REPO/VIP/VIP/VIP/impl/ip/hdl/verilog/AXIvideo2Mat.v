...
reg   [9:0] t_V_2_reg_166;
reg   [0:0] eol_reg_177;
reg   [0:0] eol_1_reg_189;
reg   [23:0] axi_data_V_1_reg_200;
reg   [0:0] axi_last_V_3_reg_247;
reg   [23:0] axi_data_V_3_reg_259;
reg   [23:0] tmp_data_V_reg_355;
reg   [0:0] tmp_last_V_reg_363;
wire   [0:0] exitcond2_fu_290_p2;
wire    ap_CS_fsm_state4;
wire   [8:0] i_V_fu_296_p2;
reg   [8:0] i_V_reg_379;
...
reg   [0:0] axi_last_V1_reg_135;
wire    ap_CS_fsm_state10;
wire    ap_CS_fsm_state3;
reg   [23:0] axi_data_V1_reg_145;
reg   [8:0] t_V_reg_155;
...
wire   [0:0] ap_phi_reg_pp1_iter1_axi_last_V_2_reg_211;
wire   [23:0] ap_phi_reg_pp1_iter1_p_Val2_s_reg_224;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((exitcond2_fu_290_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((exitcond_fu_302_p2 == 1'd1) & (1'b0 == ap_block_pp1_stage0_subdone) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((exitcond2_fu_290_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_reg_384 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_fu_302_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        sof_1_fu_92 <= 1'd0;
...
always @ (posedge ap_clk) begin
    if (((exitcond_fu_302_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if ((((eol_2_reg_236 == 1'd0) & (1'b0 == ap_block_pp2_stage0_11001) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0)) | ((1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_predicate_op56_read_state6 == 1'b1)) | ((1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2)))) begin
...
always @ (*) begin
    if (((exitcond2_fu_290_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((1'b1 == ap_condition_507)) begin
        if ((brmerge_reg_393 == 1'd1)) begin
            ap_phi_mux_axi_last_V_2_phi_fu_216_p4 = eol_1_reg_189;
        end else if ((brmerge_reg_393 == 1'd0)) begin
...
always @ (*) begin
    if (((exitcond_reg_384 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) | ((eol_2_reg_236 == 1'd0) & (1'b0 == ap_block_pp2_stage0) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0)) | ((brmerge_reg_393 == 1'd0) & (exitcond_reg_384 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((tmp_user_V_fu_281_p1 == 1'd0) & (1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else if (((tmp_user_V_fu_281_p1 == 1'd1) & (1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    ap_block_pp1_stage0_01001 = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op56_read_state6 == 1'b1)) | ((exitcond_reg_384 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_reg_384 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_reg_384 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp1_stage0_11001 = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op56_read_state6 == 1'b1)) | ((exitcond_reg_384 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_reg_384 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_reg_384 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op56_read_state6 == 1'b1)) | ((exitcond_reg_384 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_reg_384 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_reg_384 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0))));
end

assign ap_block_pp2_stage0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp2_stage0_11001 = ((eol_2_reg_236 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_enable_reg_pp2_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp2_stage0_subdone = ((eol_2_reg_236 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_enable_reg_pp2_iter1 == 1'b1));
end
...
always @ (*) begin
    ap_block_state6_pp1_stage0_iter1 = (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op56_read_state6 == 1'b1)) | ((exitcond_reg_384 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_reg_384 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_reg_384 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0)));
end

assign ap_block_state8_pp2_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state9_pp2_stage0_iter1 = ((eol_2_reg_236 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out));
end

always @ (*) begin
    ap_condition_507 = ((exitcond_reg_384 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0));
end
...
assign ap_phi_reg_pp1_iter1_axi_last_V_2_reg_211 = 'bx;

assign ap_phi_reg_pp1_iter1_p_Val2_s_reg_224 = 'bx;

always @ (*) begin
    ap_predicate_op56_read_state6 = ((brmerge_reg_393 == 1'd0) & (exitcond_reg_384 == 1'd0));
end

assign ap_ready = internal_ap_ready;

assign brmerge_fu_317_p2 = (sof_1_fu_92 | ap_phi_mux_eol_phi_fu_181_p4);

assign exitcond2_fu_290_p2 = ((t_V_reg_155 == 9'd480) ? 1'b1 : 1'b0);

assign exitcond_fu_302_p2 = ((t_V_2_reg_166 == 10'd640) ? 1'b1 : 1'b0);

assign i_V_fu_296_p2 = (t_V_reg_155 + 9'd1);

assign img_data_stream_0_V_din = ap_phi_mux_p_Val2_s_phi_fu_228_p4[7:0];

assign img_data_stream_1_V_din = {{ap_phi_mux_p_Val2_s_phi_fu_228_p4[15:8]}};

assign img_data_stream_2_V_din = {{ap_phi_mux_p_Val2_s_phi_fu_228_p4[23:16]}};

assign j_V_fu_308_p2 = (t_V_2_reg_166 + 10'd1);

assign src_axi0_TREADY = AXI_video_strm_V_dest_V_0_state[1'd1];

assign start_out = real_start;

assign tmp_user_V_fu_281_p1 = AXI_video_strm_V_user_V_0_data_out;
