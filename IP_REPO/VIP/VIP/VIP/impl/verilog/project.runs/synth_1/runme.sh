...
HD_PWD='D:/BaiduNetdiskDownload/P10_SD_VGA_m/IP_REPO/VIP/VIP/VIP/impl/verilog/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vip1_m.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vip1_m.tcl
