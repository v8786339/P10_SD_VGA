...
HD_PWD='D:/BaiduNetdiskDownload/P10_SD_VGA_m/IP_REPO/VIP/VIP/VIP/impl/verilog/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vip1_m.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vip1_m.tcl -notrace
