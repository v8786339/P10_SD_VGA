...
`define TV_OUT_dst_axi_TDATA "../tv/rtldatafile/rtl.vip1_m.autotvout_dst_axi_V_data_V.dat"
`define EGRESS_STATUS_dst_axi_TDATA "../tv/stream_size/stream_egress_status_dst_axi_V_data_V.dat"
`define TV_OUT_dst_axi_TKEEP "../tv/rtldatafile/rtl.vip1_m.autotvout_dst_axi_V_keep_V.dat"
`define EGRESS_STATUS_dst_axi_TKEEP "../tv/stream_size/stream_egress_status_dst_axi_V_keep_V.dat"
`define TV_OUT_dst_axi_TSTRB "../tv/rtldatafile/rtl.vip1_m.autotvout_dst_axi_V_strb_V.dat"
`define EGRESS_STATUS_dst_axi_TSTRB "../tv/stream_size/stream_egress_status_dst_axi_V_strb_V.dat"
`define TV_OUT_dst_axi_TUSER "../tv/rtldatafile/rtl.vip1_m.autotvout_dst_axi_V_user_V.dat"
`define EGRESS_STATUS_dst_axi_TUSER "../tv/stream_size/stream_egress_status_dst_axi_V_user_V.dat"
`define TV_OUT_dst_axi_TLAST "../tv/rtldatafile/rtl.vip1_m.autotvout_dst_axi_V_last_V.dat"
`define EGRESS_STATUS_dst_axi_TLAST "../tv/stream_size/stream_egress_status_dst_axi_V_last_V.dat"
`define TV_OUT_dst_axi_TID "../tv/rtldatafile/rtl.vip1_m.autotvout_dst_axi_V_id_V.dat"
`define EGRESS_STATUS_dst_axi_TID "../tv/stream_size/stream_egress_status_dst_axi_V_id_V.dat"
`define TV_OUT_dst_axi_TDEST "../tv/rtldatafile/rtl.vip1_m.autotvout_dst_axi_V_dest_V.dat"
...
module AESL_axi_s_dst_axi (
    ...
    fifo #(1228800, 24) fifo_dst_axi_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(1228800, 3) fifo_dst_axi_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(1228800, 3) fifo_dst_axi_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(1228800, 1) fifo_dst_axi_TUSER (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(1228800, 1) fifo_dst_axi_TLAST (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(1228800, 1) fifo_dst_axi_TID (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(1228800, 1) fifo_dst_axi_TDEST (
        .reset(1'b0),
        .write_clock(clk),
