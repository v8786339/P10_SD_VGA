...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "vip1_m.autotvin.dat"
	set constFileTvOut       "vip1_m.autotvout.dat"
	set constFileHdlTvIn     "vip1_m.autohdltvin.dat"
	set constFileHdlTvOut    "vip1_m.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
