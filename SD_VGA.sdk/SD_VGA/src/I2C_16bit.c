...
XIicPs	Iic;
struct config_table ov7670_default_regs[] =
{
		...
		{0x40,0xD0},//"; -- COM15  Full 0-255 output, RGB 565
		{0x3a,0x04},//"; -- TSLB   Set UV ordering,  do not auto-reset window
		{0x14,0x38},//"; -- COM9  - AGC Celling
		{0x4f,0x80},//"; -- MTX1  - colour conversion matrix
		{0x50,0x80},//"; -- MTX2  - colour conversion matrix
		{0x51,0x00},//"; -- MTX3  - colour conversion matrix
		{0x52,0x22},//"; -- MTX4  - colour conversion matrix
		{0x53,0x5e},//"; -- MTX5  - colour conversion matrix
		{0x54,0x80},//"; -- MTX6  - colour conversion matrix
		{0x58,0x9e},//"; -- MTXS  - Matrix sign and auto contrast
		{0x55,0x00},//"; -- MTXS  - Matrix sign and auto contrast
		{0x56,0x40},//"; -- MTXS  - Matrix sign and auto contrast
		{0x3a,0x04},//"; -- MTXS  - Matrix sign and auto contrast
		{0x67,0xc0},//"; -- MTXS  - Matrix sign and auto contrast
		{0x68,0x80},//"; -- MTXS  - Matrix sign and auto contrast
		...
		{0x72,0x00},//"; -- SCALING_DCWCTR  -- zzz was 11
		{0x73,0x00},//"; -- SCALING_PCLK_DIV
		{0xa2,0x00},//"; -- SCALING_PCLK_DELAY  must match COM14
        {0x15,0x00},//"; -- COM10 Use HREF not hSYNC
		{0xB0,0x84},//"; -- ABLC1 - Turn on auto black level
		{0xB1,0x04},//"; -- ABLC1 - Turn on auto black level
		{0x13,0x8F},//"; -- COM8  - AGC, White balance
		{0xFF,0xFF},//"; -- spare
		{0xFF,0xFF},//"; -- spare
		{0x00,0x00},//"; -- spare
		{0x00,0x00},//"; -- spare
		{0x13,0x8F},//"; -- COM8 - AGC, White balance
		{0x00,0x00},//"; -- spare
		{0x10,0x00},//"; -- AECH Exposure
		{0x0D,0x40},//"; -- COMM4 - Window Size
		{0x00,0x00},//"; -- spare
		{0xa5,0x05},//"; -- AECGMAX banding filter step
		{0x24,0x95},//"; -- AEW AGC Stable upper limite
		{0x25,0x33},//"; -- AEB AGC Stable lower limi
		{0x26,0xe3},//"; -- VPT AGC fast mode limits
		{0x9f,0x78},//"; -- HRL High reference level
		{0xA0,0x68},//"; -- LRL low reference level
		{0xa1,0x03},//"; -- DSPC3 DSP control
		{0xA6,0xd8},//"; -- LPH Lower Prob High
		{0xA7,0xd8},//"; -- UPL Upper Prob Low
		{0xA8,0xf0},//"; -- TPL Total Prob Low
		{0xA9,0x90},//"; -- TPH Total Prob High
		{0xAA,0x94},//"; -- NALG AEC Algo select
		{0x13,0xE5},//
...
int I2C_write_byte(XIicPs *InstancePtr,u8 sensor_slave_addr,void *write_byte,int byte_num)
{
	...
	if(Status != XST_SUCCESS){
		xil_printf("IIC Send byte Failed %d!",Status);
	}
...
int I2C_config_init(void)
{
	...
	while(ov7670_default_regs[i].addr != Config_done)
	{
		I2C_write(&Iic,ov7670_default_regs[i].addr,ov7670_default_regs[i].data);
		i++;
	}
